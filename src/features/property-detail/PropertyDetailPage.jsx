  ...
  if (!property) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-32 text-center space-y-4">
        ...
        <p className="text-2xl font-bold text-slate-700">{t('notFound.title')}</p>
  ...
  return (
    <article className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <button
        type="button"
        onClick={() => navigate(-1)}
        className="mb-6 inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-100 text-slate-700 font-semibold hover:bg-slate-200 transition-colors"
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          {property.description && (
            <div className="prose prose-slate max-w-none mb-12">
              <h2 className="text-xl font-bold text-slate-950 mb-4">Descripción</h2>
